...
from fabricatio.models.generic import AsPrompt, Language, PersistentAble, SketchedAble, Titled, WithRef


class ArticleProposal(SketchedAble, WithRef[str], AsPrompt, PersistentAble, Titled, Language):
