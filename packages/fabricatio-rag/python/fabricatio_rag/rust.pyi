...
@typing.final
class TEIClient:
    r"""TEI (Text Embedding Inference) client for interacting with embedding and reranking services.
    ...
    def connect(base_url: builtins.str) -> typing.Awaitable[TEIClient]:
        r"""Creates a new TEI client connected to the specified base URL.
    ...
    def arerank(
        ...
        truncation_direction: builtins.str = "Left",
    ) -> typing.Awaitable[typing.List[typing.Tuple[int, float]]]:
        r"""Reranks a list of texts based on their relevance to the given query.
    ...
    def embed_all(
        self, text: builtins.str, truncate: builtins.bool = False, truncation_direction: builtins.str = "Left"
    ) -> typing.Awaitable[typing.List[typing.List[float]]]:
        r"""Generates token-level embeddings for the given text.
    ...
    def embed(
        ...
        truncate: builtins.bool = False,
        truncation_direction: builtins.str = "Left",
    ) -> typing.Awaitable[typing.List[float]]:
        r"""Generates embeddings for the given text.
