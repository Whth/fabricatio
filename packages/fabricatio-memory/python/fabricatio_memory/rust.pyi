...
class MemorySystem:
    """
    Manages a collection of memories, providing functionalities for adding,
    retrieving, searching, and maintaining memories. It uses a full-text search
    ...
    def update_memory(self, id: int, content: Optional[str] = None, importance: Optional[float] = None, tags: Optional[List[str]] = None) -> bool:
        """
    ...
    def get_all_memories(self) -> List[Memory]:
        ...
        Note: This may be performance-intensive for very large memory sets.
