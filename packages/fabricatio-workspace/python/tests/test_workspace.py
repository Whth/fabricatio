...
import pytest
from fabricatio_workspace.rust import commit, fork, prune
...
class TestRustBindingsInterface:
    ...
    def test_fork_signature_and_return_type(self) -> None:
        ...
        with pytest.raises(RuntimeError):
            ...
            fork(repo_path=repo_path, to=dest_path, branch_name=branch, base_branch="main", exist_ok=False)
