...
class MCPManager:
    ...
    def ping(self, client_id: builtins.str) -> typing.Any:
        ...
        """
    def call_tool(self, client_id: builtins.str, tool_name: builtins.str, arguments: typing.Optional[dict]) -> typing.Any:
        r"""
...
def gather_violations(source: builtins.str, modules: typing.Optional[CheckConfig] = None, imports: typing.Optional[CheckConfig] = None, calls: typing.Optional[CheckConfig] = None) -> builtins.list[builtins.str]:
    r"""
    Gathers violations in the provided source code based on the given configuration.
    """

def treeview(directory: typing.Optional[builtins.str | os.PathLike | pathlib.Path] = None, max_depth: builtins.int = 10) -> builtins.str:
    r"""
