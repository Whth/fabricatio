...
class ContentBlockParser:
    ...
    @staticmethod
    def with_delimiters(left_delimiter: builtins.str, right_delimiter: typing.Optional[builtins.str] = None) -> ContentBlockParser:
        r"""
...
class JsonParser:
    ...
    def convert_all(self, text: builtins.str, fix: builtins.bool = True) -> builtins.list[typing.Any]:
        ...
        """
    def validate_list(self, text: builtins.str, elements_type: typing.Type[_T]|None = None, length: typing.Optional[builtins.int] = None, fix: builtins.bool = True) -> typing.List[_T]|None:
        r"""
        ...
        """
    def validate_list_str(self, text: builtins.str, length: typing.Optional[builtins.int] = None, fix: builtins.bool = True) -> typing.List[str]|None:
        r"""
        ...
        """
    def validate_set(self, text: builtins.str, elements_type: typing.Type[_T]|None = None, length: typing.Optional[builtins.int] = None, fix: builtins.bool = True) -> typing.Set[_T]|None:
        r"""
        ...
        """
    def validate_dict(self, text: builtins.str, key_type: typing.Type[_K]|None = None, value_type: typing.Type[_V]|None = None, length: typing.Optional[builtins.int] = None, fix: builtins.bool = True) -> typing.Dict[_K, _V]|None:
        r"""
        ...
        """
    def validate_dict_str_str(self, text: builtins.str, length: typing.Optional[builtins.int] = None, fix: builtins.bool = True) -> typing.Dict[str, str]|None:
        r"""
...
@typing.final
class Router:
    def completion(self, send_to: builtins.str, message: builtins.str, stream: builtins.bool = False, top_p: typing.Optional[builtins.float] = None, temperature: typing.Optional[builtins.float] = None, max_completion_tokens: typing.Optional[builtins.int] = None, presence_penalty: typing.Optional[builtins.float] = None, frequency_penalty: typing.Optional[builtins.float] = None, no_cache: builtins.bool = False) -> typing.Awaitable[str]:
        r"""
        ...
        """
    def completion_batch(self, send_to: builtins.str, messages: typing.Sequence[builtins.str], stream: builtins.bool = False, top_p: typing.Optional[builtins.float] = None, temperature: typing.Optional[builtins.float] = None, max_completion_tokens: typing.Optional[builtins.int] = None, presence_penalty: typing.Optional[builtins.float] = None, frequency_penalty: typing.Optional[builtins.float] = None, no_cache: builtins.bool = False) -> typing.Awaitable[typing.List[str|None]]:
        r"""
        ...
        """
    def embedding(self, send_to: builtins.str, texts: typing.Sequence[builtins.str], no_cache: builtins.bool = False) -> typing.Awaitable[typing.List[typing.List[float]]]:
        r"""
        ...
        """
    def rerank(self, send_to: builtins.str, query: builtins.str, documents: typing.Sequence[builtins.str], no_cache: builtins.bool = False) -> typing.Awaitable[typing.List[typing.Tuple[int, float]]]:
        r"""
        ...
        """
    def add_provider(self, provider_type: ProviderType, name: typing.Optional[builtins.str] = None, api_key: typing.Optional[SecretStr] = None, endpoint: typing.Optional[builtins.str] = None) -> None:
        r"""
        ...
        """
    def add_completion_model(self, group: builtins.str, model_identifier: builtins.str, rpm: typing.Optional[builtins.int] = None, tpm: typing.Optional[builtins.int] = None) -> None:
        r"""
        ...
        Returns:
            None: This is an asynchronous operation that modifies the router state.
        """
    def add_embedding_model(self, group: builtins.str, model_identifier: builtins.str, rpm: typing.Optional[builtins.int] = None, tpm: typing.Optional[builtins.int] = None) -> None:
        r"""
        ...
        Returns:
            None: This is an asynchronous operation that modifies the router state.
        """
    def add_reranker_model(self, group: builtins.str, model_identifier: builtins.str, rpm: typing.Optional[builtins.int] = None, tpm: typing.Optional[builtins.int] = None) -> None:
        r"""
        ...
        Returns:
            None: This is an asynchronous operation that modifies the router state.
        """
    def add_or_update_dummy_completion_model(self, group: builtins.str, model_identifier: builtins.str, responses: typing.Sequence[builtins.str]) -> None: ...
...
class TemplateManager:
    ...
    def template_count(self) -> builtins.int:
        ...
        """
    def add_store(self, source: builtins.str | os.PathLike | pathlib.Path, rediscovery: builtins.bool = False) -> TemplateManager:
        r"""
        ...
        """
    def add_stores(self, sources: typing.Sequence[builtins.str | os.PathLike | pathlib.Path], rediscovery: builtins.bool = False) -> TemplateManager:
        r"""
...
class TextCapturer:
    ...
    def capture_generic_block(language: builtins.str = 'String') -> TextCapturer:
        ...
        """
    @staticmethod
    def capture_content(left_delimiter: builtins.str, right_delimiter: typing.Optional[builtins.str] = None) -> TextCapturer:
        r"""
...
def split_into_chunks(string: builtins.str, max_chunk_size: builtins.int, max_overlapping_rate: builtins.float = 0.3) -> builtins.list[builtins.str]:
    r"""
