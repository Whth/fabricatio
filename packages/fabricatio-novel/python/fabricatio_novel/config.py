...
class NovelConfig:
    ...
    chapter_rewrite_request_template: str = "built-in/chapter_rewrite_request"
    """template used to render the rewrite request appendix for state-violation regeneration."""
    character_state_board_template: str = "built-in/character_state_board"
    """template used to render the Character State Board prompt injection."""
    chapter_previous_states_template: str = "built-in/chapter_previous_states"
    """template used to render the per-character previous chapter-end states baseline."""
