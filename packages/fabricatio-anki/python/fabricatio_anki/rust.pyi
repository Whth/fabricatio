...
class AnkiDeckLoader:
    ...
    def create_project_template(
        ...
        Args:
            project_path (str): The path where the project template should be created.
            deck_name (Optional[str]): The name of the deck. Defaults to "Sample Deck".
            deck_description (Optional[str]): Description of the deck. Defaults to "A sample Anki deck".
            author (Optional[str]): The author of the deck. Defaults to "Generated by Fabricatio".
            model_name (Optional[str]): The name of the model. Defaults to "basic_card".
            fields (Optional[List[str]]): List of field names. Defaults to ["Front", "Back"].
        """
