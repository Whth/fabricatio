...
def add_csv_data(
    project_path: builtins.str | os.PathLike | pathlib.Path,
    model_name: builtins.str,
    data: builtins.str | os.PathLike | pathlib.Path,
) -> None:
    r"""Adds CSV data to an Anki deck project.
...
def compile_deck(
    ...
    r"""Compiles an Anki deck from a path to an output file.
...
def create_deck_project(
    ...
    r"""Creates a new Anki deck project with the given configuration.
...
def extract_html_component(html: builtins.str) -> tuple[builtins.str, builtins.str, builtins.str]:
    r"""Extracts JavaScript, CSS, and layout components from an HTML string.
...
def save_metadata(dir_path: builtins.str | os.PathLike | pathlib.Path, name: builtins.str, data: typing.Any) -> None:
    r"""Saves metadata to a YAML file in the specified directory.
...
def save_template(
    ...
    r"""Saves Anki card templates (front, back, and optional CSS) to files.
