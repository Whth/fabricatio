...
def start_service(frontend_dir: builtins.str | os.PathLike | pathlib.Path, data_dir: builtins.str | os.PathLike | pathlib.Path, addr: builtins.str, node_registry_json: builtins.str, blueprints_json: builtins.str, allowed_origins: typing.Sequence[builtins.str], submit_fn: typing.Any, cancel_fn: typing.Any, queue_snapshot_fn: typing.Any, history_snapshot_fn: typing.Any, rebuild_roles_fn: typing.Any) -> typing.Awaitable[None]:
    r"""
