"""Demonstrate rule-based content generation — creating bilingual (English/Chinese) writing rulesets that enforce citation formatting conventions when writing academic articles."""
...
from fabricatio_actions.actions import PersistentAll
...
class Role(RoleBase, UseLLM):
    """A researcher role with LLM capability for drafting writing rulesets."""


async def main() -> None:
    """Demonstrate ruleset generation: define citation formatting rules in both English and Chinese, use DraftRuleSet actions to produce structured RuleSet objects, and persist them for later use."""
    Role(
