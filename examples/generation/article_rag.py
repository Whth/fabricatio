...
class Connect(Action):
    """Connect the article to the outline. Establishes a reference chain: article_briefing → article_proposal → article_outline → article, enabling downstream actions to trace provenance."""
