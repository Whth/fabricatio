"""Demonstrates song composition: uses the Compose action to have an LLM generate structured Song objects (title, lyrics, chords) from a natural-language request describing the desired genre, theme, and structure."""
