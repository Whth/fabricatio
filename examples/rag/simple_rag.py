"""Demonstrate Retrieval-Augmented Generation (RAG) — inserting company policy documents into a Milvus vector database, then answering user questions by retrieving relevant policies before the LLM call."""
...
class Role(ProposeTask, BaseRole):
    """A RAG-enabled role that can propose tasks and answer questions using a vector database."""
